...
#
# y_prob = tf.nn.softmax(y_hat,name='y_prob')
#
# xentropy = tf.nn.sparse_softmax_cross_entropy_with_logits(labels=y, logits=y_hat)
...
#         print(epoch,'batch acc:'+str(acc_batch)+'val acc:'+str(acc_val)+'val_loss'+str(loss_val)+'loss_batch:'+str(loss_batch))
#
